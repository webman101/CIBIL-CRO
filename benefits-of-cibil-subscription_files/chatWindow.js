        ...
        return (function ($) {
            ...
            chatWindow.prototype.init = function () {
                ...
                if(!me.config.minimizeMode){
                    ...
                    chatWindowHtml.find('.minimized-title').html("Chat with " + me.config.chatTitle);
                    me.skipedInit=true;
                }
            ...
            chatWindow.prototype.bindEvents = function () {
                ...
                _chatContainer.off('click', '.minimize-btn').on('click', '.minimize-btn', function (event) {
                    if (me.minimized === true) {
                        ...
                        _chatContainer.find('.minimized-title').html("Chat with " + me.config.chatTitle);
                        me.minimized = true;
                        if (me.expanded === true) {
                            $('.kore-chat-overlay').hide();
                        }
                ...
                bot.on("open", function (response) {
                    ...
                    var _chatInput = _chatContainer.find('.kore-chat-footer .chatInputBox');
                    _chatContainer.find('.kore-chat-header .header-title').html('Chat with CIBIL').attr('title', me.config.chatTitle);
                ...
                var chatWindowTemplate = '<script id="chat_window_tmpl" type="text/x-jqury-tmpl"> \
                    ...
                    <div class="kr-wiz-menu-chat defaultTheme-kore">\
                        ...
                        <div class="kore-chat-header"> \
                            <div id="botHeaderTitle" aria-labelledby="botHeaderTitle" class="header-title" title="${chatTitle}">Chat with CIBIL</div> \
                        ...
                        <div role="region" aria-live="assertive" class="kore-chat-body"> \
							...
							Please do not disclose any personal information with your questions.</div>\
